...
T = TypeVar("T", bound="WebcastRoomSendChatResponse")


@_attrs_define
class WebcastRoomSendChatResponse:
    """
    Attributes:
        data (WebcastRoomSendChatResponseData):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        extra = WebcastRoomSendChatResponseExtra.from_dict(d.pop("extra"))

        status_code = d.pop("status_code")

        webcast_room_send_chat_response = cls(
            data=data,
            extra=extra,
            status_code=status_code,
        )

        webcast_room_send_chat_response.additional_properties = d
        return webcast_room_send_chat_response
