...
class RoomUnmuteUserAPIResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.webcast_room_unmute_user_route_output import WebcastRoomUnmuteUserRouteOutput  # noqa: PLC0415
        ...
        room_unmute_user_api_response.additional_properties = d
