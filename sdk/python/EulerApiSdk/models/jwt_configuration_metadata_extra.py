...
T = TypeVar("T", bound="JWTConfigurationMetadataExtra")
...
class JWTConfigurationMetadataExtra:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        jwt_configuration_metadata_extra = cls()
        ...
        jwt_configuration_metadata_extra.additional_properties = additional_properties
        return jwt_configuration_metadata_extra
