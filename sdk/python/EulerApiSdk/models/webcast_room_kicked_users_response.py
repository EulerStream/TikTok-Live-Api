...
class WebcastRoomKickedUsersResponse:
    """
    Attributes:
        data (list[WebcastRoomKickedUsersResponseDataItem]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = WebcastRoomKickedUsersResponseDataItem.from_dict(data_item_data)
        ...
        webcast_room_kicked_users_response.additional_properties = d
