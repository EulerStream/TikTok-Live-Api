...
T = TypeVar("T", bound="WebcastLiveAnalyticsVideoDetailRouteOutput")


@_attrs_define
class WebcastLiveAnalyticsVideoDetailRouteOutput:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        webcast_live_analytics_video_detail_route_output = cls(
            data=data,
        )

        webcast_live_analytics_video_detail_route_output.additional_properties = d
        return webcast_live_analytics_video_detail_route_output
