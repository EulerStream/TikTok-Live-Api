...
from ...models.add_room_moderator_response_429 import AddRoomModeratorResponse429
from ...models.add_room_moderator_response_500 import AddRoomModeratorResponse500
from ...models.add_room_moderator_response_503 import AddRoomModeratorResponse503
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 429:
        response_429 = AddRoomModeratorResponse429.from_dict(response.json())

        return response_429

    if response.status_code == 500:
        response_500 = AddRoomModeratorResponse500.from_dict(response.json())

        return response_500

    if response.status_code == 503:
        response_503 = AddRoomModeratorResponse503.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    AddRoomModeratorResponse429 | AddRoomModeratorResponse500 | AddRoomModeratorResponse503 | RoomAdminUpdateAPIResponse
]:
    return Response(
...
def sync_detailed(
    ...
    **Authentication:** Provide exactly one of the following headers:
    ...
    Returns:
        Response[AddRoomModeratorResponse429 | AddRoomModeratorResponse500 | AddRoomModeratorResponse503 | RoomAdminUpdateAPIResponse]
    """
