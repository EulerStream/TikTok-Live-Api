...
inputSpec: ./build/openapi.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{01A2851F-F7CF-4F1D-BD44-14BC327A260C}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IGetRateLimitsApiResponse apiResponse = await api.GetRateLimitsAsync("todo");
            GetRateLimits? model = apiResponse.Ok();
        }
